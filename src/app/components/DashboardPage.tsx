...
export function DashboardPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex flex-col items-center justify-center py-24 gap-4">
        <div className="w-16 h-16 border-4 border-blue-200 border-t-blue-600 rounded-full animate-spin" />
        <p className="text-slate-500">AI 모델이 분석 중입니다...</p>
        <p className="text-slate-400 text-sm">Redis → AI Worker → MLP 추론</p>
      </div>
    );
  }
